...
# Alle modulker har tilgang til conftest.py. Se tutorial 16:20.00
...
def test_user2(client):
    user_data = {"email": "hei6@hei.no", "password": "hei123"}
...
def test_user(client):
    user_data = {"email": "hei3@hei.no", "password": "hei123"}
    r = client.post("/users/", json=user_data)
...
def test_posts(test_user, session, test_user2):
    posts_data = [
        ...
        {"title": "3st title", "content": "3st content", "owner_id": test_user["id"]},
        {"title": "User 2 title", "content": "user2 content", "owner_id": test_user2["id"]},
    ]
